...
### Slide 28
$$C(n,m_1)*C(n-m_1,m_2) * ... * C(m_k,m_k)$$
$$= \frac{n!}{(n-m_1)!m_1!} * \frac{(n-m_1)!}{(n-m_1-m_2)!m_2!} * ... * \frac{m_k!}{m_k!(m_k - m_k!)}$$
$$= \frac{n!}{m_1!*...*m_k!}$$
...
The cycle representation of $f$ is: $$f = (1, 2, 4) \circ (3, 8, 7) \circ (5) \circ (6, 9)$$
...
$$\langle f_0, f_1, ...\rangle = F(x) = f_0x^0 + f_1x^1 + f_2x^2 + ...$$
